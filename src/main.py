...
tf.flags.DEFINE_integer('iters', 400, 'number of iterations, default: 100000')
tf.flags.DEFINE_integer('print_freq', 20, 'print frequency for loss, default: 10')
tf.flags.DEFINE_integer('eval_freq', 40, 'evalue performance at test set, default: 100')
tf.flags.DEFINE_integer('save_freq', 200, 'save frequency for model, default: 10000')
